...
export const courseData: Record<string, any> = {
    '1': { // Civil Engineering
      '1': [
        ...
        { code: 'CE101', name: 'Engineering Graphics & Design', credits: 3 },
        { code: 'PH111', name: 'Physics Laboratory', credits: 2 },
        { code: 'EE111', name: 'Basic Electrical Engineering Laboratory', credits: 2 },
      ...
      '2': [
        ...
        { code: 'CE102', name: 'Environmental Science & Engineering', credits: 3 },
        { code: 'CH111', name: 'Chemistry Laboratory', credits: 2 },
        { code: 'CS111', name: 'Programming Laboratory', credits: 2 },
        { code: 'EC111', name: 'Basic Electronics Laboratory', credits: 2 },
        { code: 'ME111', name: 'Workshop Practice', credits: 2 },
        { code: 'EAA', name: 'Extra-Curricular Activities', credits: 0 },
      ],
      '3': [
    ...
    '2': { // Computer Science and Engineering
      ...
      '3': [
        ...
        { code: 'CS203', name: 'Data Structure Laboratory', credits: 2 },
        { code: 'EE224', name: 'Microprocessor Laboratory', credits: 2 },
        { code: 'EC222', name: 'Circuits and Switching Laboratory', credits: 2 },
      ],
      '4': [
        ...
        { code: 'CS208', name: 'Object Oriented Programming Laboratory', credits: 3 },
        { code: 'CS209', name: 'Algorithms Laboratory', credits: 2 },
    ...
    '3': { // Electrical Engineering
      ...
      '3': [
        ...
        { code: 'EC226', name: 'Analog Electronics Laboratory', credits: 2 },
      ],
      '4': [
    ...
    '4': { // Electronics and Communication Engineering
      ...
      '3': [
        ...
        { code: 'CS223', name: 'Data Structure and Algorithm Lab', credits: 2 },
        ...
        { code: 'EE222', name: 'Electrical Machines Laboratory', credits: 2 },
        { code: 'MA201', name: 'Mathematics III', credits: 4, resourceUrl: subjectResourceLinks['MA201'] },
      ],
      '4': [], '5': [], '6': [], '7': [], '8': [],
    },
    '5': { // Electronics and Instrumentation Engineering
      ...
      '4': [
        ...
        { code: 'EL214', name: 'Sensor and Transducers Lab', credits: 2 },
        { code: 'EI215', name: 'Control System Lab', credits: 2 },
        { code: 'EI216', name: 'Digital Electronics Lab', credits: 2 },
        { code: 'EL217', name: 'Power Electronics Lab', credits: 2 },
      ],
      '5': [
        { code: 'EI301', name: 'Industrial Instrumentation-I', credits: 4 },
        { code: 'EI302', name: 'Biomedical Instrumentation', credits: 4 },
        { code: 'EL303', name: 'Microprocessors & Micro Controllers', credits: 3 },
        ...
        { code: 'EL312', name: 'Biomedical Instrumentation Lab', credits: 2 },
        { code: 'EI313', name: 'Communication & Telemetry Lab', credits: 2 },
        { code: 'EI314', name: 'Virtual Instrumentation Lab', credits: 3 },
      ],
      '6': [
        { code: 'EL306', name: 'Industrial Instrumentation-II', credits: 4 },
        ...
        { code: 'EI333', name: 'Computer Networks (Elec. I)', credits: 4 },
        { code: 'EI334', name: 'PC Based Instrumentation (Elec. I)', credits: 4 },
        { code: 'EI335', name: 'Electro-Magnetic Field Theory (Elec. I)', credits: 4 },
        { code: 'EI336', name: 'Smart Sensors (Elec. I)', credits: 4 },
        { code: 'EI337', name: 'Optimization Techniques (Elec. I)', credits: 4 },
        { code: 'EI381', name: 'Air Pollution and Environmental Instrumentation (Open Elec. I)', credits: 3 },
        { code: 'EI382', name: 'Opto-Electronics and Fibre Optics (Open Elec. I)', credits: 3 },
        { code: 'EI383', name: 'Digital Image Processing (Open Elec. I)', credits: 3 },
        { code: 'EI384', name: 'Wind and Solar Based System (Open Elec. I)', credits: 3 },
        { code: 'EI385', name: 'Soft Computing Techniques and Applications (Open Elec. I)', credits: 3 },
        { code: 'EI386', name: 'Wireless Sensor Networks (Open Elec. I)', credits: 3 },
        { code: 'EI387', name: 'Logic and Distributed Control System (Open Elec. I)', credits: 3 },
        { code: 'EL388', name: 'Aerospace and Navigation Instrumentation (Open Elec. I)', credits: 3 },
        { code: 'EI315', name: 'Instrumentation Lab', credits: 2 },
        { code: 'EL316', name: 'Industrial Process Control and Automation Lab', credits: 2 },
      ...
      '7': [
        ...
        { code: 'EI432', name: 'Biomedical Signal Processing (Elec. II)', credits: 4 },
        { code: 'EI433', name: 'Real Time Embedded Systems (Elec. II)', credits: 4 },
        { code: 'EI434', name: 'IoT based Instrumentation (Elec. II)', credits: 4 },
        { code: 'EI435', name: 'MEMS & Nanotechnology (Elec. II)', credits: 4 },
        { code: 'EI436', name: 'Non Linear Control Systems (Elec. II)', credits: 4 },
        { code: 'EI437', name: 'Linear Integrated Circuits (Elec. II)', credits: 4 },
        { code: 'EI481', name: 'Robotics and Automation (Open Elec. II)', credits: 3 },
        { code: 'EI482', name: 'Instrumentation in Petrochemical Industry (Open Elec. II)', credits: 3 },
        { code: 'EI483', name: 'Neural Networks and Fuzzy logic (Open Elec. II)', credits: 3 },
        { code: 'EI484', name: 'Renewable Energy Systems (Open Elec. II)', credits: 3 },
        { code: 'EI485', name: 'Machine Learning (Open Elec. II)', credits: 3 },
        { code: 'EI486', name: 'Probability and Random Processes (Open Elec. II)', credits: 3 },
        { code: 'EI487', name: 'Human Computer Interfaces (Open Elec. II)', credits: 3 },
        { code: 'EI488', name: 'Mobile Adhoc and Sensor Networks (Open Elec. II)', credits: 3 },
        { code: 'EI489', name: 'Aquaponics Monitoring and Control (Open Elec. II)', credits: 3 },
        { code: 'HS401_Econ_EIE', name: 'Managerial Economics', credits: 3 },
        { code: 'EI497', name: 'Industrial Training (Minimum 6 weeks)', credits: 2 },
        { code: 'EI498', name: 'Project I', credits: 4 },
      ],
      '8': [
        { code: 'MS401_Biz_EIE', name: 'Business Management', credits: 3 },
        { code: 'EI441', name: 'Advanced Sensors and Signal Processing (Elec. III)', credits: 4 },
        { code: 'EI442', name: 'Piping and Instrumentation (Elec. III)', credits: 4 },
        { code: 'EI443', name: 'Industrial Automation (Elec. III)', credits: 4 },
        { code: 'EI444', name: 'Wireless Communication (Elec. III)', credits: 4 },
        { code: 'EI445', name: 'Adaptive Control (Elec. III)', credits: 4 },
        { code: 'EI446', name: 'Analog Integrated Circuit Design (Elec. III)', credits: 4 },
        { code: 'EI447', name: 'Mechatronics (Elec. III)', credits: 4 },
        { code: 'EI490', name: 'Intelligent Instrumentation (Open Elec. III)', credits: 3 },
        { code: 'EI491', name: 'Advanced Process Control (Open Elec. III)', credits: 3 },
        { code: 'EI492', name: 'Bio-signal Processing (Open Elec. III)', credits: 3 },
        { code: 'EI493', name: 'Advanced Memory Technology (Open Elec. III)', credits: 3 },
        { code: 'EI494', name: 'Introduction to Cyber Physical systems (Open Elec. III)', credits: 3 },
        { code: 'EI495', name: 'Optimization Methods in Engineering (Open Elec. III)', credits: 3 },
        { code: 'E1496A', name: 'Information Theory, Cryptography & Security (Open Elec. III)', credits: 3 },
        { code: 'EI496B', name: 'Modelling and Control of Energy Storage Systems (Open Elec. III)', credits: 3 },
