...
export const subjectResourceLinks: Record<string, string> = {
    'PH11001': 'https://drive.google.com/drive/folders/147YmLk5qp1NVxEx8eNDXF9sF_VZxk6GL',
    'MA11001': 'https://drive.google.com/drive/folders/1HnAqiAJY6fAuERZkl32TQxqweG8_GkGa',
    'ME11001': 'https://drive.google.com/drive/folders/1cyXrwYZiomyyNp2EXWtLp-JXxnn1o2TR',
    'EE11001': 'https://drive.google.com/drive/folders/1AqbzsAIEyizz4DBLEDdVfoZ0jMAdQ-OU',
    'HS11001': 'https://drive.google.com/drive/folders/14GNnV6koq-Q4SVJMBTzd9cuuACB57y3D',
    'CY11001': 'https://drive.google.com/drive/folders/1YZUeyo8h5ozlicDmt3T5au98y2PwH7WP',
    'MA11002': 'https://drive.google.com/drive/folders/18DM3oy-T_XYt2SYwkmjiextB8qi6c5bK',
    'CS11001': 'https://drive.google.com/drive/folders/1YIXxJA2ztKMYkma5m-mwy1GDYS3NJ2Z9',
    'EC11001': 'https://drive.google.com/drive/folders/1vjj1Qk7CmZGK1JcdOiMOh-IW9MFsUnF3',
    'CE11002': 'https://drive.google.com/drive/folders/1_X2q2Pri3t3q_zJB8z2M385EXihQ-Ql3',
    'CY12001': 'https://drive.google.com/drive/folders/1mwEHInY0pIZoE5QxlhLMjQ9QOgCNW8l4',
    'EC12001': 'https://drive.google.com/drive/folders/1cGV6IMWHsQhNI2faj8e6aXnqJ-ZBn-QX',
    'ME12001': 'https://drive.google.com/drive/folders/1vMwe3yT07Vukina8UAoWNZWZg47qhF5U',
    'CE11001': 'https://drive.google.com/drive/folders/10uqjaCfgaaVaUIKpe9ijcrncxs8LgLAE',
    'PH12001': 'https://drive.google.com/drive/folders/1_lqVeLaTOXgwlP9qeYe0l3gJiS69ULbP',
    'EE12001': 'https://drive.google.com/drive/folders/1EmNHA8AmoEe3D58oa18kOFWsVKrL49Wu',
...
const addDefaultResourceLinks = (subjects: any[]) => {
    return subjects.map(subject => {
        ...
        if (linkFromMap) {
            return { ...subject, resourceUrl: linkFromMap };
        }
        
        return { ...subject, resourceUrl: DEFAULT_RESOURCE_LINK }; 
    });
};
...
const rawCourseData: Record<string, any> = {
    '1': { 
      '1': [
        { code: 'PH11001', name: 'Physics I', credits: 3 },
        { code: 'MA11001', name: 'Mathematics I', credits: 3 },
        { code: 'CS11001', name: 'Intro to Computer Programming', credits: 2 },
        { code: 'HS11001', name: 'English Communication', credits: 2 },
        { code: 'CE11003', name: 'Engineering Mechanics', credits: 3 },
        { code: 'CE12001', name: 'Engineering Graphics & Design Lab', credits: 2 },
        { code: 'CS12001', name: 'Computer Programming Lab', credits: 2 },
        { code: 'PH12001', name: 'Physics Lab', credits: 2 },
        { code: 'HS12001', name: 'English Language Lab', credits: 1 },
      ],
      '2': [
        { code: 'CY11001', name: 'Chemistry', credits: 3 },
        { code: 'MA11002', name: 'Mathematics II', credits: 3 },
        { code: 'EE11001', name: 'Basic Electrical Engineering', credits: 3 },
        { code: 'EC11001', name: 'Basic Electronics Engineering', credits: 3 },
        { code: 'CE11002', name: 'Environmental Science', credits: 2 },
        { code: 'CY12001', name: 'Chemistry Lab', credits: 2 },
        { code: 'EE12001', name: 'Basic Electrical Engineering Lab', credits: 2 },
        { code: 'EC12001', name: 'Basic Electronics Engineering Lab', credits: 2 },
        { code: 'ME12001', name: 'Workshop Practice', credits: 2 },
      ],
      '3': [
        { code: 'CE201', name: 'Mechanics of Materials', credits: 4 },
        { code: 'MA201', name: 'Mathematics III', credits: 4 },
    ...
    '2': { 
      '1': [
        ...
        { code: 'CS11001', name: 'Intro to Computer Programming', credits: 2 },
        { code: 'HS11001', name: 'English Communication', credits: 2 },
        { code: 'CS11003', name: 'Digital Logic Design', credits: 3 },
        { code: 'CE12001', name: 'Engineering Graphics & Design Lab', credits: 2 },
        { code: 'CS12001', name: 'Computer Programming Lab', credits: 2 },
        { code: 'PH12001', name: 'Physics Lab', credits: 2 },
        { code: 'HS12001', name: 'English Language Lab', credits: 1 },
      ...
      '2': [
        ...
        { code: 'EE11001', name: 'Basic Electrical Engineering', credits: 3 },
        { code: 'EC11001', name: 'Basic Electronics Engineering', credits: 3 },
        { code: 'ME11001', name: 'Engineering Mechanics', credits: 3 },
        { code: 'CY12001', name: 'Chemistry Lab', credits: 2 },
        { code: 'EE12001', name: 'Basic Electrical Engineering Lab', credits: 2 },
        { code: 'EC12001', name: 'Basic Electronics Engineering Lab', credits: 2 },
        { code: 'ME12001', name: 'Workshop Practice', credits: 2 },
    ...
    '3': { 
      '1': [
        ...
        { code: 'ME11001', name: 'Engineering Mechanics', credits: 3 },
        { code: 'EE11001', name: 'Basic Electrical Engineering', credits: 3 },
        { code: 'EE11003', name: 'Intro to Electrical Engineering', credits: 2 },
        { code: 'CY12001', name: 'Chemistry Lab', credits: 2 },
        { code: 'EE12001', name: 'Basic Electrical Engg. Lab', credits: 2 },
        { code: 'ME12001', name: 'Workshop Practice', credits: 2 },
      ],
      '2': [
        { code: 'PH11001', name: 'Physics I', credits: 3 },
        ...
        { code: 'CS11001', name: 'Intro to Computer Programming', credits: 2 },
        { code: 'EC11001', name: 'Basic Electronics Engineering', credits: 3 },
        { code: 'CE11001', name: 'Engineering Graphics & Design', credits: 3 },
        { code: 'HS11001', name: 'English Communication', credits: 2 },
        { code: 'PH12001', name: 'Physics Lab', credits: 2 },
        { code: 'CS12001', name: 'Computer Programming Lab', credits: 2 },
        { code: 'EC12001', name: 'Basic Electronics Engg. Lab', credits: 2 },
        { code: 'HS12001', name: 'English Language Lab', credits: 1 },
      ],
      '3': [
    ...
    '4': { 
      '1': [
        ...
        { code: 'ME11001', name: 'Engineering Mechanics', credits: 3 },
        { code: 'EE11001', name: 'Basic Electrical Engineering', credits: 3 },
        { code: 'EC11003', name: 'Intro to ECE', credits: 2 },
        { code: 'CY12001', name: 'Chemistry Lab', credits: 2 },
        { code: 'EE12001', name: 'Basic Electrical Engg. Lab', credits: 2 },
        { code: 'ME12001', name: 'Workshop Practice', credits: 2 },
      ],
      ...
      '3': [
        ...
        { code: 'EC202', name: 'Analog Electronics', credits: 4 },
    ...
    '5': { 
      '1': [
        ...
        { code: 'ME11001', name: 'Engineering Mechanics', credits: 3 },
        { code: 'EE11001', name: 'Basic Electrical Engineering', credits: 3 },
        { code: 'EI11001', name: 'Intro to EI Engineering', credits: 2 },
        { code: 'CY12001', name: 'Chemistry Lab', credits: 2 },
        { code: 'EE12001', name: 'Basic Electrical Engg. Lab', credits: 2 },
        { code: 'ME12001', name: 'Workshop Practice', credits: 2 },
      ],
      ...
      '3': [
        ...
        { code: 'EI203', name: 'Circuits & Networks', credits: 4 },
        { code: 'CS222', name: 'Data Structure & Algorithm', credits: 4 },
    ...
    '6': { 
      '1': [
        ...
        { code: 'CS11001', name: 'Intro to Computer Programming', credits: 2 },
        { code: 'HS11001', name: 'English Communication', credits: 2 },
        { code: 'ME11003', name: 'Intro to Mechanical Engineering', credits: 2 },
        { code: 'CE12001', name: 'Engineering Graphics & Design Lab', credits: 2 },
        { code: 'CS12001', name: 'Computer Programming Lab', credits: 2 },
        { code: 'PH12001', name: 'Physics Lab', credits: 2 },
        { code: 'HS12001', name: 'English Language Lab', credits: 1 },
